  ...
  return (
    <div className="fixed top-4 right-4 z-50 flex flex-col gap-2 pointer-events-none">
      {toastList.map((toast) => (
        <div
          key={toast.id}
          className={`${getToastStyles(toast.type)} px-6 py-4 rounded-lg shadow-xl flex items-center gap-3 min-w-[300px] max-w-md pointer-events-auto animate-fade-in transform transition-all duration-300`}
        >
          {getIcon(toast.type)}
